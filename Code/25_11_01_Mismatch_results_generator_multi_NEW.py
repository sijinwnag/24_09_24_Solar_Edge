...
Dataset: November 2025 new sites (9 sites: 1 single-orientation, 8 multi-orientation)
Sites: 4078782, 4025968, 4108846, 4118479, 2008772, 4022322, 4006208, 3968909, 4073684
...
# Multi-orientation site configuration for NEW dataset (November 2025)
# Based on 'Additionsl Sites (5).xlsx' orientation data
MULTI_ORIENTATION_SITES = {
    '4025968': 2,  # NAM - Pennsylvania (Multi, 2 orientations)
    '4108846': 5,  # NAM - Arizona (Multi, 5 orientations)
    '4118479': 2,  # NAM - Arizona (Multi, 2 orientations)
    '2008772': 2,  # AUS - NSW (Multi, 2 orientations, Southern hemisphere)
    '4022322': 2,  # Germany (Multi, 2 orientations)
    '4006208': 3,  # Germany (Multi, 3 orientations)
    '3968909': 3,  # Germany (Multi, 3 orientations)
    '4073684': 2,  # Germany (Multi, 2 orientations)
}

# Single-orientation site (not processed by this script - use single-orientation workflow)
SINGLE_ORIENTATION_SITES = {
    '4078782': 1,  # NAM - Virginia (Single, 1 orientation)
}

# Directory configuration
DATA_DIR = r"C:\Users\z5183876\OneDrive - UNSW\Documents\GitHub\24_09_24_Solar_Edge\25_11_01_multi_new\Telemetry Data (1)"
BASE_DIR = r"C:\Users\z5183876\OneDrive - UNSW\Documents\GitHub\24_09_24_Solar_Edge\Results\25_06_24_Results"
SUMMARY_DIR = r"C:\Users\z5183876\OneDrive - UNSW\Documents\GitHub\24_09_24_Solar_Edge\25_11_01_multi_new\Additionsl Sites (5).xlsx"
...
def load_and_process_site_data(site_id: str, season: str) -> Tuple[pd.DataFrame, List[str], str]:
    ...
    # New Excel file has headers in row 2 (index 1), not row 1 (index 0)
    summary_df = pd.read_excel(SUMMARY_DIR, sheet_name='Sheet1', header=1)
    ...
    # Southern hemisphere: Australia, AUS
    # Northern hemisphere: NAM (North America), Germany, and all others
    season_months = (SEASON_MONTHS_SOUTH if country in ['Australia', 'AUS']
                    else SEASON_MONTHS_NORTH)
...
if __name__ == "__main__":
    # Example usage
    print("Multi-Orientation Solar Array Mismatch Analysis - NEW SITES")
    print("=" * 60)
    print("Processing new dataset from November 2025")
    print("8 multi-orientation sites: 4025968, 4108846, 4118479, 2008772, 4022322, 4006208, 3968909, 4073684")
    print("1 single-orientation site (skipped): 4078782")
    print("=" * 60)
    
    # UNIT TEST: Process single site first for validation
    print("\n*** UNIT TEST MODE ***")
    ...
    # FULL PROCESSING: Uncomment to run all sites and seasons
    # print("\n*** FULL PROCESSING MODE ***")
    # run_multi_orientation_analysis(
    #     site_ids=None,  # Process all 8 multi-orientation sites
    #     seasons=['summer', 'autumn', 'winter', 'spring'],  # All seasons
    #     num_days_to_plot=10  # Full 10-day analysis
    # )